...
export const AiToolsData = [
  {
    ...
    description:
      "Draft long-form content and compelling narratives in seconds using our context-aware writing engine.",
    Icon: SquarePen,
    // Zen Signature Gradient: Electric Blue to Deep Indigo
    bg: { from: "#3744FB", to: "#4F46E5" },
    path: "/ai/write-article",
  },
  {
    title: "Blog Title Generator",
    description:
      "Stop the scroll with high-conversion headlines designed to boost CTR and search engine visibility.",
    Icon: Hash,
  ...
  },
  {
    ...
    description:
      "Bring your imagination to life with hyper-realistic visuals and artistic styles powered by neural art.",
    Icon: Image,
    // Modern Teal/Mint Gradient
    bg: { from: "#06B6D4", to: "#10B981" },
    path: "/ai/generate-images",
  },
  {
    title: "Background Removal",
    description:
      "Achieve pixel-perfect transparency instantly. Perfect for e-commerce, portraits, and product shots.",
    Icon: Eraser,
    // Vibrant Sunset Gradient
    bg: { from: "#F97316", to: "#E11D48" },
    path: "/ai/remove-background",
  },
  {
    title: "Object Removal",
    description:
      "Clean up your photos by seamlessly erasing distractions and photobombers with content-aware fill.",
    Icon: Scissors,
    // Deep Ocean Gradient
    bg: { from: "#2563EB", to: "#0891B2" },
    path: "/ai/remove-object",
  },
  {
    title: "Resume Reviewer",
    description:
      "Optimize your professional profile with AI-driven insights to bypass ATS filters and impress recruiters.",
    Icon: FileText,
    // Sophisticated Slate/Silver Gradient
